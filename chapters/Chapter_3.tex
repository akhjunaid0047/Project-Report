...
\section{Overview}
Project planning defines the structured roadmap for the development and completion of EduFeedback AI. The planning process focuses on dividing the project into well-defined phases to ensure systematic progress, effective time management, and clear deliverables at each stage. The project is planned across multiple academic semesters, allowing gradual development, validation, and refinement of system components.
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|p{4cm}|p{8cm}|}
        ...
        \begin{itemize}
            \item Design alumni registration/login portal
            \item Create structured online survey (job role, skills used, relevance rating, satisfaction)
            \item Enable option to update career progress (job change / skill growth)
        \end{itemize} \\ \hline
        Phase 2 & Teacher Feedback System \& CO Attainment Analyzer & 
        \begin{itemize}
            \item Develop teacher login panel
            \item Create digital feedback form mapped to course outcomes (COs)
            \item Allow uploading CO attainment reports
            \item Convert teacher feedback into structured database format
        \end{itemize} \\ \hline
        Phase 3 & Job–Curriculum Mapping \& Gap Analysis (AI/NLP Engine) & 
        \begin{itemize}
            \item Collect syllabus/course content (text format)
            \item Use NLP (TF-IDF / BERT embeddings) to extract key topics
            \item Extract job skill keywords from alumni responses
            \item Compare syllabus topics vs job-required skills
            \item Generate “Skill Gap Index” and matching percentage
        \end{itemize} \\ \hline
        Phase 4 & AI-Based Recommendation Engine for Curriculum Improvement & 
        \begin{itemize}
            \item Create scoring model to rate relevance of each course
            \item Suggest new modules/topics based on missing skills
            \item Identify low-ROI topics (taught but not used in job)
            \item Generate structured recommendations for syllabus revision
        \end{itemize} \\ \hline
        Phase 5 & Visualization \& Decision Support Dashboard & 
        \begin{itemize}
            \item Build interactive dashboard (Streamlit / React + API)
            \item Display analytics (graphs, heatmaps, skill gaps)
            \item Provide admin panel for HoD/IQAC/NAAC reviewers
            \item Enable export to PDF/Excel reports
        \end{itemize} \\ \hline
        Phase 6 & Testing \& Validation & 
        \begin{itemize}
            \item Test data consistency across teacher + alumni sheets
            \item Validate skill mapping via sample career Datasets
            \item Pilot use with small group of students/alumni
            \item Perform usability testing and feedback review
        \end{itemize} \\ \hline
        Phase 7 & Documentation \& Report Preparation & 
        \begin{itemize}
            \item Create project documentation (SRS, DFD, UML)
            \item Prepare final presentation PPT + demo video
            \item Draft research methodology section
        \end{itemize} \\
        \hline
    \end{tabular}
    }
...
The planning approach emphasizes requirement clarity, modular development, and incremental implementation, ensuring that the system remains adaptable to future enhancements and institutional requirements.

\section{Current Status of the Project}
At the present stage, the foundational components of the project have been completed. The following activities have been successfully carried out:
\begin{itemize}
    \item Identification of the problem domain and formulation of project objectives
    \item Detailed literature survey and analysis of existing systems
    \item Market research focusing on employability analytics and curriculum evaluation needs
    \item Design of overall system architecture using a layered client–server approach
    \item Preparation of structured feedback forms for alumni and faculty data collection
    \item Created a user friendly UI
\end{itemize}
The documentation work up to Chapter 3 has also been completed as part of the current semester deliverables.
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/job_distribution.png}
...
The data analytics layer is responsible for intelligence-driven processing. It performs natural language processing using techniques such as TF-IDF and BERT, supports skill–curriculum mapping, calculates skill gap indices, and generates recommendations for curriculum improvement.
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/system_architecture.png}
...
\section{Plan for the Upcoming Semester}
In the upcoming semester, the project will move from design to full implementation. The planned activities include:
\begin{itemize}
    \item Development of backend services and application logic
    \item Integration of analytics and scoring mechanisms
    \item Implementation of dashboards and visualization modules
    \item Testing with expanded datasets
    \item Performance evaluation and result interpretation
    \item Preparation of final documentation and project demonstration
\end{itemize}
This phase will focus on system validation and readiness for deployment.
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/gantt_chart.png}
