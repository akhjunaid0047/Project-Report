...
\begin{figure}[!h]
    \centering
     \includegraphics[width=0.7\linewidth]{figures/Chapter_2_Fig/employability_rate.png}
...
\begin{figure}[!h]
    \centering
     \includegraphics[width=0.7\linewidth]{figures/Chapter_2_Fig/employability_rate_sectors.png}
