...
$ \text{Best Match}(S, C) = \max \text{Similarity}(S, T_i) \text{ for } T_i \in C $
...
$ CRS = (w1 \times R_{\text{alumni}}) + (w2 \times M_{\text{skill}}) + (w3 \times A_{\text{CO}}) $
Where:
\begin{itemize}
    \item $w1, w2, w3$ = Institution-configured weights where $w1+w2+w3 = 1.0$
...
During the AI revision process, recommendations need to be inserted correctly back into the syllabus structure. The Diff Generator then builds a JSON object marking original strings in red (REDUCE/DELETE) and proposed new strings in green (ADD), paired directly with evidence metrics (Pmention and Wrecency) to present the Diff view to the administrator.
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/uc_admin.png}
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/uc_faculty.png}
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/uc_alumni.png}
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/dfd_alumni.png}
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/dfd_nlp.png}
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.7\linewidth]{figures/dfd_recommendation.png}
