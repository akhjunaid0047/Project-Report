...
% =========================
\begin{certificate}
This is to certify that the work embodied in this thesis entitled \textbf{``EduFeedBack AI: Post-Career Analytics \& Curriculum Refinement''} has been satisfactorily completed by \textbf{KHANDAKAR ARYANUL HAQUE} (Roll No. 221001001282), \textbf{NAVITA VERMA} (Roll No. 221001001315), \textbf{JUNAID AKHTER} (Roll No. 221001001316), \textbf{RUCHITA MISHRA} (Roll No. 221001001324), and \textbf{ARYAN HELA} (Roll No. 221001001332). It is a bonafide piece of work carried out under my supervision and guidance at Techno India University, Kolkata, for partial fulfilment of the requirements for the awarding of the \textbf{Bachelor of Technology} in \textbf{Computer Science \& Engineering} degree of the Department of Computer Science and Engineering, Techno India University, during the academic year 2025 - 2026.
